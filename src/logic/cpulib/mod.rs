...
pub(crate) fn hindu_shuffle(cards: &mut Vec<Card>, params: &HinduParams) {
...
pub(crate) fn hindu_shuffle_once(cards: &mut Vec<Card>, min_chunk: usize, max_chunk: usize) {
    if cards.len() < 2 {
        return;
    }
